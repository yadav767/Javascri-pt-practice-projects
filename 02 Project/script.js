...
function astroTalk() {
    form.addEventListener("submit", function (e) {
        ...
        result.textContent = `Hi ${name} ${surName} , Your zodiac sign is ${zodiacSigns[month - 1]}. ${compliments[day - 1]}. ${victimCardCompliments[year % 20]}. ${recommendations[(day * month) % 30]}. ${predictions[(name.length * surName.length) % 20]}`
